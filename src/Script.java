...
public abstract class Script
	 ...
	 * 
	 * @param params
	 *			the parameters entered by the user when the script is
	 *			selected.
	 */
	@Override
	 ...
	 * 
	 * @param name
	 *			the display name of the player who sent the request.
	 */
	@Override
	 ...
	 * @param mod
	 *			true if the sender is a player moderator (silver crown).
	 * @param admin
	 ...
	 * @param keycode
	 *			the key pressed expressed as an integer
	 */
	@Override
	 ...
	 * 
	 * @param style
	 *			the combat style's position in the list starting at 0.
	 */
	 ...
	 * @param skill
	 *			the skill's identifer (position in the list starting at 0).
	 ...
	 * 
	 * @param spell
	 *			the spell's identifier (position in the list starting at 0).
	 */
	 ...
	 * 
	 * @param ids
	 *			the identifiers of the items to search for.
	 ...
	 * @param x
	 *			the x position of the tile to examine.
	 * @param y
	 *			the y position of the tile to examine.
	 ...
	 * @param slot
	 *			the position of the item in the client's inventory, starting
	 *			at 0.
	 ...
	 * @see Script#getInventoryIndex(int...)
	 * @param slot_1
	 *			the position of the item in the client's inventory.
	 * @param slot_2
	 *			the position of the item in the client's inventory.
	 */
	 ...
	 * @see Script#getInventoryIndex(int...)
	 * @param spell
	 *			the spell's ID (position in the list starting at 0).
	 * @param slot
	 *			the position of the item in the client's inventory, starting
	 *			at 0.
	 */
	 ...
	 * 
	 * @param id
	 *			the id of the ground item.
	 * @param x
	 *			the x position of the ground item.
	 * @param y
	 ...
	 * @see Script#getInventoryIndex(int...)
	 * @param item_slot
	 *			the position of the item in the players inventory, starting at
	 *			0.
	 * @param ground_id
	 *			the id of the ground item.
	 * @param ground_x
	 ...
	 * @see Script#getItemById(int...)
	 * @param spell
	 *			the spell's position in the list starting at 0.
	 * @param item_id
	 *			the item's id.
	 * @param item_x
	 ...
	 *			the id of the item to use.
	 * @param object_x
	 *			x tile of the object.
	 * @param object_y
	 *			y tile of the object.
	 */
	 ...
	 * @see Script#getNpcByIdNotTalk(int...)
	 * @param id
	 *			the ID of the NPC to search for.
	 * @param start_x
	 *			the center X of the circle area.
	 * @param start_y
	 ...
	 * 
	 * @param str
	 *			the string to compare to the visible options.
	 ...
	 * @param i
	 *			the option's position in the list, starting at 0.
	 */
	 ...
	 * 
	 * @param name
	 *			the display name of the player to search for.
	 ...
	 * @param server_index
	 *			the server index of the player to search for.
	 * @return always an integer array of size 3. If no player can be found, the
	 *		 array will contain -1, -1, -1. If a player was found, the array
	 *		 will contain the player's local index, X, Y.
	 */
	 ...
	 * 
	 * @param ids
	 *			the boundary id(s) to search for.
	 ...
	 * @param x
	 *			the x position of the boundary to interact with.
	 * @param y
	 ...
	 * 
	 * @param id
	 *			the id of the item to deposit.
	 * @param amount
	 *			the number of the given item to deposit.
	 */
	 ...
	 * 
	 * @param x
	 *			the x position of the tile to compare to the client's
	 *			position.
	 * @param y
	 *			the y position of the tile to compare to the client's
	 *			position.
	 ...
	 * 
	 * @param x
	 *			the x position of the comparison tile.
	 * @param y
	 *			the y position of the comparison tile.
	 * @param radius
	 *			the maximum distance between the client and x, y for the
	 ...
	 * 
	 * @param prayer
	 *			the position of the prayer in the list, starting at 0.
	 */
	 ...
	 * @param i
	 *			the position of the item in the shop screen.
	 ...
	 * @param server_index
	 *			the server index of the player to send the request to.
	 */
	 ...
	 * @see Script#getPlayerPID(int)
	 * @param server_index
	 *			the server index of the player to start following.
	 */
	 ...
	 * 
	 * @param slot
	 *			the position of the item to offer in the client's inventory,
	 *			starting at 0.
	 * @param amount
	 *			the number of the given item to offer.
	 */
	 ...
	 *			the id of the item to search for.
	 * @param amount
	 *			the number of the item to ensure is there.
	 ...
	 * @param colour
	 *			the hex colour (24-bit RGB) of the text.
	 */
	 ...
	 * @param colour
	 *			the hex colour (24-bit RGB) of the line.
	 */
	 ...
	 * @param colour
	 *			the hex colour (24-bit RGB) of the shape.
	 */
	 ...
	 *			the height of the shape.
	 * @param trans
	 *			transparency of the shape (255-0).
	 * @param colour
	 *			the colour (24-bit RGB) of the shape.
	 */
	 ...
	 * 
	 * @param file
	 *			the file name (excluding extension) to save the screenshot as.
	 */
